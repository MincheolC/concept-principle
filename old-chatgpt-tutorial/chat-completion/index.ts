...
import { requestChatCompletionStreaming, IPromptSet, IChatCompletionData } from "./chat-completion";
...
async function main() {
  ...
  console.log("======== brainstormingHelperResult =========");
  console.log(JSON.stringify(brainstormingHelperResult));

  console.log("======== introsectionGeneratorResult =========");
  console.log(JSON.stringify(introsectionGeneratorResult));

  console.log("======== draftGeneratorResult ==========");
  console.log(JSON.stringify(draftGeneratorResult));
}
